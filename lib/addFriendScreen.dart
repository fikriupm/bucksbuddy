...
class _FriendScreenState extends State<FriendScreen> {
  ...
  Future<void> _fetchData() async {
    try {
      ...
      _currentUserFriends = await UserRepository.instance
  ...
  Widget _buildFriendTile(String friendName, VoidCallback onPressed,
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        setState(() {
          ...
          final removedFriend = _users.firstWhere((user) => user.id == friendId,
              orElse: () => UserModel.empty());
